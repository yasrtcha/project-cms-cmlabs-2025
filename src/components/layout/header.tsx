...
function HeaderComponent() {
  ...
  return (
    <div className="px-6 py-3 flex items-center justify-between border-b border-slate-200 dark:border-slate-700 transition-colors">
      ...
      <div className="bg-[#3A7AC3] dark:bg-slate-800 flex items-center space-x-4 px-4 py-2 rounded-lg">
        {/* Action buttons */}
        <Button variant="outline" size="sm" className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 dark:hover:text-white">
        ...
        <Button
          ...
          size="sm"
          onClick={toggleTheme}
          className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 dark:hover:text-white">
