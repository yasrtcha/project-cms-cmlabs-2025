...
export function BuilderSidebar({
  ...
  const toggleManagement = (section: "single" | "collection" | "component") => {
          ...
          <div className="pt-2 border-t border-gray-100 dark:border-slate-800">
            ...
            <div className="space-y-4 border-l border-gray-100 dark:border-slate-800 ml-1.5 pl-3">
              ...
              <div>
                ...
                {managementOpen.component && (
                  <div className="space-y-0.5 ml-1">
                    {components.length === 0 && <p className="text-[10px] text-gray-400 italic px-2">No components yet</p>}
