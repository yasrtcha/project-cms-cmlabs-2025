      ...
      <div className="h-screen w-full grid lg:grid-cols-2 overflow-hidden bg-white dark:bg-[#0f172a] transition-colors duration-300">
        ...
        <div className="flex flex-col h-full overflow-y-auto [&::-webkit-scrollbar]:hidden bg-white dark:bg-[#0f172a] p-8 lg:p-12 relative">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full space-y-8">
            ...
            {/* Header Text */}
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Forgot Password</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-1.5">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 bg-gray-50 dark:bg-[#1e293b] border border-transparent focus:bg-white dark:focus:bg-black focus:border-blue-500 focus:ring-0 rounded-xl text-sm transition-all outline-none text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
