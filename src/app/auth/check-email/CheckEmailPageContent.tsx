...
export default function CheckEmailPageContent() {
              ...
              <div className="mb-2">
                <div className="bg-[#0b0e14]/80 backdrop-blur-xl border border-white/10 p-6 rounded-3xl shadow-xl ring-1 ring-white/5">
                  ...
                  <p className="text-sm text-gray-400 font-light leading-relaxed">
                    Manage projects, collaborators, and content workflows
                    seamlessly from a single dashboard with clear structure and
                    control.
                  </p>
                </div>
              </div>
